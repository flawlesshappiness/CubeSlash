...
public class SoundEffectType : FakeEnum
{
    ...
    public static readonly SoundEffectType sfx_enemy_camo_appear = new SoundEffectType(nameof(sfx_enemy_camo_appear));
    ...
    public static readonly SoundEffectType sfx_ui_energy_full = new SoundEffectType(nameof(sfx_ui_energy_full));
