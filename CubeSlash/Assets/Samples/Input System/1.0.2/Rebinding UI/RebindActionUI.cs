...
namespace UnityEngine.InputSystem.Samples.RebindUI
{
    ...
    public class RebindActionUI : MonoBehaviour
    {
        ...
        public InteractiveResetEvent resetEvent
        {
            get
            {
                if (m_ResetEvent == null)
                    m_ResetEvent = new InteractiveResetEvent();
                return m_ResetEvent;
            }
        }
        ...
        public void ResetToDefault()
        {
            ...
            m_ResetEvent?.Invoke(this, action);
        ...
        [Tooltip("Optional bool which allows you to override the action label with your own text")]
        public bool m_OverrideActionLabel;

        [Tooltip("Text to be displayed when overriding the action label")]
        [SerializeField]
        private string m_ActionLabelOverrideString;
        ...
        [Tooltip("Event that is triggered when an interactive reset is completed.")]
        [SerializeField]
        private InteractiveResetEvent m_ResetEvent;
        ...
        private void UpdateActionLabel()
        {
            if (m_ActionLabel != null)
            {
                ...
                {
                    m_ActionLabel.text = m_ActionLabelOverrideString;
                }
                else
                {
        ...
        [Serializable]
        public class InteractiveResetEvent : UnityEvent<RebindActionUI, InputAction>
        {
        }
    }
}
